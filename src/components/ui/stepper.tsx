...
function StepperIndicator({ children, className, style }: React.ComponentProps<'div'>) {
  const { state, isLoading } = useStepItem();
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'relative flex items-center overflow-hidden justify-center shrink-0 rounded-full',
        'size-6 text-[16px] leading-[16px] font-semibold',
        'data-[state=active]:size-6 data-[state=active]:bg-[var(--stepper-active-bg)] data-[state=active]:text-[var(--stepper-active-fg)]',
        'data-[state=inactive]:bg-[var(--stepper-inactive-bg)] data-[state=completed]:bg-[var(--stepper-active-bg)] data-[state=completed]:text-[var(--stepper-active-fg)]',
        className,
      )}
      style={{ fontFamily: 'var(--font-poppins, var(--font-headings))', ...(style || {}) }}
    >
...
function StepperTitle({ children, className }: React.ComponentProps<'h3'>) {
  ...
  return (
    <h3
      ...
      className={cn(
        'text-center',
        'text-[16px] leading-[28px] font-medium',
        'font-[var(--font-headings)]',
        'text-white',
        className,
      )}
      style={{ fontFamily: 'var(--font-poppins, var(--font-headings))' }}
    >
      {children}
    </h3>
  );
